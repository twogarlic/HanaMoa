...
URL_SUMMARY = "https://m.stock.naver.com/front-api/marketIndex/prices?category=exchange&reutersCode=FX_JPYKRW_SHB&page=1"
URL_TICKS   = "https://m.stock.naver.com/front-api/chart/pricesByPeriod?reutersCode=FX_JPYKRW_SHB&category=exchange&chartInfoType=marketindex&scriptChartType=day"
...
def fetch_today_last_tick_fields():
    ...
    if last is None:
        raise ValueError("오늘/어제 틱 데이터를 찾을 수 없습니다.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if page_arg:
            ...
            # 기본 텍스트 출력
            result = fetch_all_flat(include_daily=False)
